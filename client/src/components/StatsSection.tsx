...
const stats: StatItem[] = [
  ...
  },
  {
    ...
    cta: { text: "Read our success stories", url: "#case-studies" },
  },
  {
    number: "6 months",
    description: "Average payback period for creative service subscriptions.",
    cta: { text: "Learn about our pricing", url: "#pricing" },
  },
];
export function StatsSection() {
  return (
    <section
      className="relative overflow-hidden bg-brand-blue-900 text-brand-beige-100 py-20 md:py-28 lg:py-36"
